...
class Session {
  ...
  final List<Exercise> _exercices;
  List<Exercise> get exercices => List.unmodifiable(_exercices);
  ...
  Exercise submitAnswer(RealExerciseAnswer answer) {
    // TODO
    _nextExercice();
